 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.pillreminder.kevinpelgrims.com", ownerName = "backend.pillreminder.kevinpelgrims.com", packagePath = ""))
